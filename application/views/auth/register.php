                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="<?= base_url('auth/register'); ?>">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="name" name="namo" value="<?= set_value('namo'); ?>" placeholder="Full Name">
                            ...
                            <div class="text-center">
                                <a class="small" href="<?= base_url('auth'); ?>">Already have an Account? Please Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
